...
class FormValidator {
  ...
  _toggleButtonState(inputList, buttonElement) {
    if (this._hasInvalidInput(inputList)) {
      buttonElement.classList.add(this.settingsObj.inactiveButtonClass);
      buttonElement.disabled = true;
    } else {
      buttonElement.classList.remove(this.settingsObj.inactiveButtonClass);
      buttonElement.disabled = false;
    }
  };
  ...
  */
  _setEventListeners() {
    const inputList = Array.from(this.formElement.querySelectorAll(this.settingsObj.inputSelector));
    // this.inputList = inputList;
    const buttonElement = this.formElement.querySelector(this.settingsObj.submitButton);
    //check inputs if validated first, to set save button
